...
* goal
  * PostgreSQL databases' physical storage format

## Database File Layout

* goal
  * (files & directories)' storage format

* `PGDATA`
  * == cluster's data directory / 
    * contains
      * 👀configuration directories & data files -- used by a -- database cluster 👀
    * NORMALLY, | "/var/lib/pgsql/data" 
  * == environment variable

| `PGDATA`'s Items | Description |
|------|-------------|
...
| postgresql.conf | can be stored \| ANYWHERE <br/>  &nbsp;&nbsp; == NOT required here |
| pg_hba.conf | can be stored \| ANYWHERE <br/>  &nbsp;&nbsp; == NOT required here |
| pg_ident.conf | can be stored \| ANYWHERE <br/>  &nbsp;&nbsp; == NOT required here |
